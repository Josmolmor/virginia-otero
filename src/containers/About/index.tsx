    ...
    <Container>
      ...
      {documents && documents[0] && documents[0].data.text && (
        <Content>
          ...
          <PrismicRichText
            ...
            components={{
              heading1: ({ children }) => (
                <H1 key="h1" style={{ margin: '0 0 2rem 0' }}>
                  {children}
                </H1>
              ),
      ...
      <VideoContainer>
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/tv/CUDZsJQgM45/?utm_source=ig_embed&amp;utm_campaign=loading"
        ...
        >
          <div style={{ padding: '16px' }}>
            <a
              href="https://www.instagram.com/tv/CUDZsJQgM45/?utm_source=ig_embed&amp;utm_campaign=loading"
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0 0',
            ...
            >
              <a
                ...
                rel="noreferrer"
              >
                A post shared by Vɪrɢɪɴɪᴀ Oᴛᴇro | Psicología
                (@laconsultadevirginia)
              </a>
            </p>
          </div>
        </blockquote>
